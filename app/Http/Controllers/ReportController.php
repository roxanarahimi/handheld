...
//        }
        ...
        $dm = InvoiceItem::where('id' , 17858)->first();
        $dm->delete();
        $d = InvoiceItem::where('id' , 17856)->first();
        $d->update([ 'Quantity' => 66]);
         $d1 = InvoiceItem::where('id' , 17857)->first();
...
//        $t = InvoiceProduct::orderByDesc('id')->with('invoiceItems')->doesntHave('invoiceItems')->get()->each->delete();
        ...
        $t = InvoiceItem::orderByDesc('id')->with('product')->doesntHave('product')->get();
        return $t;
